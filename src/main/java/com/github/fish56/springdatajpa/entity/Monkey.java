...
public class Monkey {
    ...
    // 自定义命名规则
    @Column(name = "birth_day") // 默认就是 驼峰命名->下换线命名
...
// create table monkey (id smallint not null, birth_day datetime, name varchar(20) not null,
// profile varchar(255), update_time datetime, primary key (id))
